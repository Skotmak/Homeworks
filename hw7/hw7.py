...
m4 = Pencil("карандаши", "черные",50)
m5 = Pencil("ручки", "синие")
m6 = Pencil("линейки","красные", 1000)

print (m4.what,m4.color,m4.where)
print (m5.what,m5.color,m5.where)
print (m6.what,m6.color,m6.where)

print ("Наличие на складе: ")
print (m4.numbers, m4.where)
print (m6.numbers, m6.where)