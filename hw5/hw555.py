...
c2 = canvas(title='Solar system model', width=1900, height=850,)
...
Jupiter = sphere(canvas=c2, pos=vector(15.3, 0, 0), texture='texture_jupiter.jpg', radius=0.699, make_trail=True, trail_type='points', trail_radius=0.01)
Saturn = sphere(canvas=c2, pos=vector(21.8, 0, 0), texture='texture_saturn.jpg', radius=0.582, make_trail=True, trail_type='points', trail_radius=0.01)
Uran = sphere(canvas=c2, pos=vector(26.7, 0, 0), texture='texture_uran.jpg', radius=0.253, make_trail=True, trail_type='points', trail_radius=0.01)
